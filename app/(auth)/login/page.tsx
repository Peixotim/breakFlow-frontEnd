  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center overflow-hidden bg-gray-50 text-gray-900 selection:bg-[#89F336]/30 dark:bg-[#121214] dark:text-[#EDEDED]">
      ...
      <div className="relative w-full h-screen lg:flex overflow-hidden">
        ...
        <div className="absolute top-8 right-8 z-30"><ThemeToggle /></div>
        ...
        <div className={`absolute top-0 left-0 w-full lg:w-1/2 h-full flex flex-col justify-center items-center p-8 transition-all duration-500 ${isRegisterMode ? 'opacity-100 z-10' : 'opacity-0 z-0 pointer-events-none'}`}>
           <div className="w-full max-w-[420px]">
              <div className="mb-6 text-center lg:text-left">
                ...
                <p className="text-sm text-gray-500 dark:text-[#888888]">Junte-se ao time BreakFlow.</p>
              </div>
              <AnimatePresence>
              ...
              <form onSubmit={handleEmployeeRegister} className="space-y-3 overflow-visible">
                ...
                <InputGroup icon={<Building />} placeholder="CNPJ da sua Empresa" name="companyCnpj" value={employeeData.companyCnpj} onChange={handleEmployeeChange} label="CNPJ da Empresa" onBlur={handleBlur} />
                <InputGroup icon={<FileText />} placeholder="Seu CPF (só números)" name="cpf" value={employeeData.cpf} onChange={handleEmployeeChange} label="CPF" onBlur={handleBlur} />
        ...
        <div className={`absolute top-0 right-0 w-full lg:w-1/2 h-full flex flex-col justify-center items-center p-8 transition-all duration-500 ${!isRegisterMode ? 'opacity-100 z-10' : 'opacity-0 z-0 pointer-events-none'}`}>
          <div className="w-full max-w-[420px]">
            ...
            <AnimatePresence>
                {error && !isRegisterMode && (
                  <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="bg-red-500/10 text-red-400 p-3 rounded-xl mb-4 text-sm text-center">{error}</motion.div>
                )}
            </AnimatePresence>
            ...
            <form onSubmit={handleLogin} className="space-y-5 overflow-visible">
              ...
              <div className="group space-y-2">
                ...
                <div className="relative transition-all duration-300 group-focus-within:scale-[1.01]">
                  ...
                  <input type="password" name="password" placeholder="••••••••••••" value={loginData.password} onChange={handleLoginChange} className="input-field" required />
                </div>
              </div>
            ...
            <div className="mt-10 text-center lg:hidden">
              <p className="text-sm font-medium text-gray-500 dark:text-[#666]">
                ...
                <button onClick={() => setIsRegisterMode(true)} className="font-bold text-[#1a7c37] hover:underline dark:text-[#89F336]">
                  Ativar sua conta
                </button>
              </p>
            </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 dark:border-white/10 text-center">
                ...
                <Link 
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm 
                             ...
                             dark:text-[#0B0C10] dark:bg-white dark:hover:bg-gray-200 dark:shadow-white/20
            ...
            <AnimatePresence mode="wait">
              {!isRegisterMode ? (
                <motion.div key="login-text" variants={contentVariants} initial="hidden" animate="visible" exit="exit">
                  ...
                  <p className="text-lg leading-relaxed font-medium text-white/90 mb-6">Ainda não faz parte do time?</p>
                ...
                <motion.div key="register-text" variants={contentVariants} initial="hidden" animate="visible" exit="exit">
                  ...
                  <p className="text-lg leading-relaxed font-medium text-white/90 mb-8">Já possui credenciais? Volte para acessar seu painel.</p>
